...
const DashedBorderTag: React.FC<DashedBorderTagTS>=({icon,tag})=>(
    ...
    <div className="inline-flex items-center gap-1 border border-dashed border-blue-200 bg-blue-50 px-[4px] py-0.5 text-blue-500 text-[14px] font-medium whitespace-nowrap">
